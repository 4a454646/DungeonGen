...
public class DungeonAssembler : MonoBehaviour {
    ...
    private void Start() {
        ...
        StartCoroutine(CreateRoomCoro(0, 1, "s"));
        StartCoroutine(CreateRoomCoro(1, 0, "w"));
        StartCoroutine(CreateRoomCoro(0, -1, "n"));
        StartCoroutine(CreateRoomCoro(-1, 0, "e"));
